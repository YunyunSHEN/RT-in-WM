...
if sum(abs(estimation_relative) < 0.1)/numb_rect == 1
    DrawFormattedText(w, 'BRAVO!! ',P.xcenter+x_step*9,P.ycenter+y_step*2, P.Color.black);
    DrawFormattedText(w, '+', 'center', 'center', P.Color.black);
%     Screen('FillRect', w, P.Color.green, [P.xcenter-x_step*6, P.ycenter-y_step*4,P.xcenter+x_step*6, P.ycenter+y_step*4]);
    ...
    if numb_rect == 1
        xl_rect = [lwidth+x_step*12 nan nan nan nan nan nan];
        xy_rect = [rwidth+x_step*12 nan nan nan nan nan nan];
    elseif numb_rect == 2
        xl_rect=[lwidth+x_step*9 lwidth+x_step*14 nan nan nan nan nan];
        xy_rect=[rwidth+x_step*9 rwidth+x_step*14 nan nan nan nan nan];
%     elseif numb_rect == 3
...
%             Y_rect(i) = P.ycenter;
            y_rect(i) = P.ycenter+y_step*2+ y_step*estimation_relative(i)*-1;
            Y_rect(i) = P.ycenter+y_step*2;
        else
%             y_rect(i) = P.ycenter;
%             Y_rect(i) = P.ycenter + y_step*estimation_relative(i)*-1;
            y_rect(i) = P.ycenter+y_step*2;
    ...
    for k = 1:numb_rect
        ...
        Screen('FillRect', w, P.Color.black, [P.xcenter+x_step*2, P.ycenter-1+y_step*2,P.xcenter+x_step*22, P.ycenter+1+y_step*2]);
